...
| Core size budget | A measured limit on Core node growth and type annotation growth for representative programmes, used to prevent typed-IR blow-up before backend work.        |
